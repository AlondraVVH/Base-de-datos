-- **************************************************
-- Script 3: Creación de TODOS los Procedimientos Almacenados
-- (Versión corregida SIN 'SELECT ROW_COUNT()' y CON SINTAXIS CORRECTA)
-- **************************************************
...
BEGIN
    ...
    WHERE id_rol = p_id_rol AND deleted = 0;
END //
...
BEGIN
    ...
    SET deleted = 1, updated_at = CURRENT_TIMESTAMP 
    WHERE id_curso = p_id_curso AND deleted = 0;
END //
...
BEGIN
    ...
    SET deleted = 1, updated_at = CURRENT_TIMESTAMP 
    WHERE id_institucion = p_id_institucion AND deleted = 0;
END //
